...
#ifndef Voice_ModulatorConfig_H
#define Voice_ModulatorConfig_H
...
namespace Voice_ModulatorConfig
{
    static const unsigned short CompanyID = 64;
    static const unsigned short PluginID = 15481;
}

#endif // Voice_ModulatorConfig_H
