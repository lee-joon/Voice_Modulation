...
class Voice_ModulatorPlugin final
    : public AK::Wwise::Plugin::AudioPlugin
{
public:
    Voice_ModulatorPlugin();
    ~Voice_ModulatorPlugin();
...
DECLARE_AUDIOPLUGIN_CONTAINER(Voice_Modulator);	// Exposes our PluginContainer structure that contains the info for our plugin
