...
#ifndef Voice_ModulatorFX_H
#define Voice_ModulatorFX_H
...
private:
    Voice_ModulatorFXParams* m_pParams;
    AK::IAkPluginMemAlloc* m_pAllocator;
    AK::IAkEffectPluginContext* m_pContext;

    std::vector<AkReal32> m_PreRMS;
    std::vector<AkReal32> m_ResultAmp;

    AkReal32 m_CalculatorAmp = 0.0f;
    ...
    AkUInt32 m_Timer;
    AkReal32 m_SampleRate;

    AkReal32 Average = 0.01f;

    //Parameter    low Q        0 - 3
    //Parameter    low Freq     0 - 20000
    // 
    //Parameter    carrier Choice OSC   0 - 3
    //Parameter    modular Choice OSC   0 - 3
};

#endif // Voice_ModulatorFX_H
